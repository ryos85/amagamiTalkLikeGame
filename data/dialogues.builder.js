...
(function(){
  ...
  function createDialogues(packName = "pack"){
     ...
     *  - girl:     女の子の返答（文字列 or 配列 or "A|B|C"）
    ...
    function add(type, tension, tier, player, girl, effect = {}, weight = 1){
      ...
      // "A|B|C" と配列の両対応に寄せておく
      const girlVariants = Array.isArray(girl) ? girl
                        : (typeof girl === "string" ? girl.split("|") : [String(girl)]);
      bucket.push({ player, girl: girlVariants, effect, weight });
    }
